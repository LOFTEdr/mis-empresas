    ...
    <>
      ...
      `}>
        ...
        <div className="flex-1 px-4 space-y-2 overflow-y-auto min-h-0">
          ...
          <NavItem id="work" icon={Briefcase} label="Trabajos" />
        ...
        {/* Footer / User / Tools */}
        <div className="p-4 border-t border-gray-100 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-800/50 space-y-3 relative shrink-0">
          {/* Tools */}
          ...
          <div className="relative">
            ...
            {isUserMenuOpen && (
              <div className="absolute bottom-full left-0 w-full mb-2 bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-100 dark:border-gray-700 overflow-hidden z-30">
                <button
                  onClick={() => {
                    onLogout();
